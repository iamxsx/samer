...
public class PhotoUtil {
    ...
    public static Bitmap getImageThumbnail(String imagePath, int width,
        ...
        //禁止图片加载到内存，置为true之后，BitmapFactory.decodeFile()生成的图片不会被加载到内存
        options.inJustDecodeBounds = true;
        // 获取这个图片的宽和高，注意此处的bitmap为null，这一步是为了获取options，得到其中的图像宽高，用来计算缩放比例
